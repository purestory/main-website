...
export const projectsData: ProjectData[] = [
  // AI/ML 서비스
  { name: 'OpenWebUI', description: 'Ollama용 웹 인터페이스', link: 'http://ai-open.kr:3000/', type: 'AI/ML Service', status: 'Docker', iconUrl: openwebuiIcon, windowId: 'openwebui-window' },
  ...
  { name: 'Kokoro FastAPI', description: '다국어 TTS 서비스', link: 'http://ai-open.kr:3200/web/', type: 'AI/ML Service', status: 'Docker', windowId: 'kokoro-window' },

  // 웹 서비스
  { name: 'N8N', description: '워크플로우 자동화', link: 'http://ai-open.kr:5678/', type: 'Web Service', status: 'Docker' },
