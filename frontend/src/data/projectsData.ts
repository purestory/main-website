...
export const projectsData: ProjectData[] = [
  // AI/ML 서비스
  { name: 'OpenWebUI', description: 'Ollama용 웹 인터페이스', link: 'http://itsmyzone.iptime.org:3000/', type: 'AI/ML Service', status: 'Docker', iconUrl: openwebuiIcon, windowId: 'openwebui-window' },
  ...
  { name: 'Kokoro FastAPI', description: '다국어 TTS 서비스', link: 'http://itsmyzone.iptime.org:3200/web/', type: 'AI/ML Service', status: 'Docker', windowId: 'kokoro-window' },
